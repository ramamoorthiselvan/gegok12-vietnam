            ...
            <div class="flex flex-wrap custom-table my-3 overflow-auto">
                <table class="w-full">
                    <thead class="bg-grey-light">
                        <tr class="border-b">
                            <th class="text-left text-sm px-2 py-2 text-grey-darker"> Teacher Name </th>
    ...
    export default {
        ...
        methods:
        {
            ...
            { 
                ...
                axios.get('/receptionist/leave/list?page='+page).then(response => {
            ...
            showOthers(e)
            {
                if (e.target.checked) 
                {
                    ...
                    this.final = this.url+'/receptionist/leave/list?'+this.searchquery;
                ...
                else if (!e.target.checked)
                {
                    ...
                    this.getData('/receptionist/leave/list');
