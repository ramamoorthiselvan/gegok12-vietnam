          ...
          <tr>
            <td style="padding:40px 56px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:20px; color:#111;">
                ...
                <!-- Company Name -->
                <tr>
                  <td style="padding:16px 0; width:34%; font-weight:700; vertical-align:top;">Company Name</td>
                  <td style="padding:16px 0; vertical-align:top;">{{ ucfirst($visitorlog->company_name) }}</td>
                </tr>
                <!-- Contact Number -->
                <tr>
                  <td style="padding:16px 0; width:34%; font-weight:700; vertical-align:top;">Contact Number</td>
                  <td style="padding:16px 0; vertical-align:top;">{{ $visitorlog->contact_number }}</td>
                </tr>
                <!-- Address -->
                <tr>
                  <td style="padding:16px 0; width:34%; font-weight:700; vertical-align:top;">Address</td>
                  <td style="padding:16px 0; vertical-align:top;">{{ $visitorlog->address }}</td>
                </tr>
